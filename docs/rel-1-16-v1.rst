*********************************************
Autodoc for K8s Rel 1.16 v1 document classes
*********************************************

This page contains the docstrings for the top-level classes
(HikaruDocumentBase subclasses)
in ``hikaru.model.rel_1_16.v1.documents``. Instances of these classes are used
...
set of classes in ``hikaru.model.rel_1_16.v1.v1``.
...
.. automodule:: hikaru.model.rel_1_16.v1.documents
   :members:
