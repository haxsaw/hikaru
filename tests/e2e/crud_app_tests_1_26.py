...
class CRUD_1_26(Application):
    ...
    def standard_instance(cls, namespace: str):
        ...
        app = CRUD_1_26(dep=dep, ns=Namespace(metadata=ObjectMeta(name=namespace)))
        return app
...
def test01():
    ...
    """
    app: CRUD_1_26 = CRUD_1_26.standard_instance(test_ns + "test01")
    result = False
    try:
        _ = app.delete()
...
def test02():
    ...
    Testing create
    """
    app: CRUD_1_26 = CRUD_1_26.standard_instance(test_ns + "test02")
    assert app.create()
    assert app.delete()
...
def test03():
    ...
    app: CRUD_1_26 = CRUD_1_26.standard_instance(test_ns + "test03")
    assert app.create()
    try:
        read_app: CRUD_1_26 = CRUD_1_26.read(instance_id=app.instance_id)
...
def test04():
    ...
    """
    app: CRUD_1_26 = CRUD_1_26.standard_instance(test_ns + "-test04")
    assert app.create()
    try:
        app = CRUD_1_26.read(app.instance_id)
        app = CRUD_1_26.read(app.instance_id)
        time.sleep(0.2)
        app = CRUD_1_26.read(app.instance_id)
        ...
        app.update()
        new_app: CRUD_1_26 = CRUD_1_26.read(app.instance_id)
